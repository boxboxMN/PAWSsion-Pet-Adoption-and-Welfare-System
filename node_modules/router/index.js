...
function matchLayer (layer, path) {
  ...
  try {
    ...
    let sanitizedPath = path.length > 2048 ? path.substring(0, 2048) : path; // Limit path length to prevent ReDoS

    sanitizedPath = sanitizedPath.replace(/[\0\x08\x09\x1a\n\r"'\\\%]/g, char => {
    ...
    return layer.match(sanitizedPath)
